          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="7">丙酮<el-input v-model="sjhphOne" style="width:130px"
                  :readonly="Details.status == '2' || isJCRY"></el-input>
                酸性洗涤剂<el-input v-model="sjhphTwo" style="width:130px"
                  :readonly="Details.status == '2' || isJCRY"></el-input>
                <!-- 淀粉酶<el-input v-model="sjhphThree" placeholder="批号" style="width:130px"
                  :readonly="isJCRY"></el-input>无水亚硫酸钠<el-input v-model="sjhphFour" placeholder="批号" style="width:130px"
                  :readonly="isJCRY"></el-input> -->
              </td>
            </tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="text-align: center;">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>ADF 含量 x（%）</td>
                      <td>平均值(g/kg)</td>
                      <td>相对相差/绝对偏差(g/kg)</td>
                      <td>鲜样中中 ADF 含量 (g/kg)</td>
                      <td>操作</td>
                    </tr>
                    <template v-for="(item, index) in Details.infoList">
                      <tr :key="`row1-${index}`" class="sample-split" :class="{ 'first-sample': index === 0 }">
                        ...
                        <td><el-input :value="computex(item)" readonly></el-input></td>
                    ...
                    <tr>
                      ...
                      <td colspan="10" style="text-align:left">ADF 含量&gt;5%时，允许绝对差值≤1%; ADF 含量在 5%~10%时，允许相对相差≤10%;ADF
                        含量&lt;
                        10%，允许相对相差&gt;6%。</td>
                    </tr>
                  </tbody>
