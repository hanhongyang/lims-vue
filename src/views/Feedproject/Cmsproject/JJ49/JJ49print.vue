        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th style="width:15%" colspan="2"">主要仪器名称</th>
              <th style="width:10%">仪器编号</th>
              <th style="width:14%" colspan="2">检测依据</th>
...
export default {
  ...
  mounted() {
    if (this.$route.params.SjtaskInfo) {
      ...
      // 设置数据
      localStorage.setItem('jj49SjtaskInfo', JSON.stringify(this.Details));


    } else {
      this.Details = JSON.parse(localStorage.getItem('jj49SjtaskInfo'))
    }
    this.initTimes();
