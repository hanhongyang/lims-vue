        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th style="width:15%" colspan="2">仪器编号</th>
            ...
            <tr>
              ...
              <td colspan="2">{{ instrumentNoOne }}</td>
            ...
            <tr>
              ...
              <td colspan="2">{{ instrumentNoTwo }}</td>
...
export default {
  ...
  mounted() {
    if (this.$route.params.SjtaskInfo) {
      ...
      // 设置数据
      localStorage.setItem('jj48SjtaskInfo', JSON.stringify(this.Details));


    } else {
      this.Details = JSON.parse(localStorage.getItem('jj48SjtaskInfo'))
    }
    this.initTimes();
