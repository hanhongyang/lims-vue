            ...
            <tr>
              <td colspan="10" style="padding: 0; border: 0;">
                <table cellpadding="0" cellspacing="0" width="100%"
                  ...
                  <tr>
                    <td style="width: 16.65%;border-top: 0;border-left: 0;border-bottom: 0;">OA 标准液浓度(ug/kg)</td>
                    <td style="width: 13.33%; border-top: 0;border-bottom: 0;">0</td>
                    <td style="width: 13.33%; border-top: 0;border-bottom: 0;">0.05</td>
                    <td style="width: 13.33%; border-top: 0;border-bottom: 0;">0.15</td>
                    <td style="width: 13.33%; border-top: 0;border-bottom: 0;">0.45</td>
                    <td style="width: 13.33%; border-top: 0;border-right: 0;border-bottom: 0;">1.35</td>
                  </tr>
                </table>
              </td>
            </tr>
