      ...
      <div class="pagemain" v-for="forindex in forindex" :key="'forindex' + forindex">
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            ...
            <tr>
              <td colspan="2">振荡器提取时间</td>
              <td colspan="2">静置时间</td>
              <td colspan="2">孵育时间</td>
              <td colspan="3">反应时间</td>
            </tr>
            <tr>
              <td colspan="2">{{ oneBeforeTimeLeft }}：{{ oneBeforeTimeRight }}——{{ oneAfterTimeLeft }}：{{
                oneAfterTimeRight }}</td>
              <td colspan="2">{{ twoBeforeTimeLeft }}：{{ twoBeforeTimeRight }}——{{ twoAfterTimeLeft }}：{{
                twoAfterTimeRight }}</td>
              <td colspan="2">{{ threeBeforeTimeLeft }}：{{ threeBeforeTimeRight }}——{{ threeAfterTimeLeft }}：{{
                threeAfterTimeRight }}</td>
