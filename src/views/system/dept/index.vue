  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      <el-form-item label="公司名称" prop="deptName">
        <el-input v-model="queryParams.deptName" placeholder="请输入公司名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="deptList" row-key="deptId"
      ...
      <el-table-column prop="deptName" label="公司名称" ></el-table-column>
      <el-table-column label="类型" align="center" prop="deptType"  width="400">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item label="类型" prop="deptType">
              <el-select v-model="form.deptType" placeholder="请选择类型">
                <el-option v-for="dict in dict.type.dept_type" :key="dict.value" :label="dict.label"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="邮箱授权码" prop="emailAuthorizationCode">
              <el-input 
                v-model="form.emailAuthorizationCode" 
  ...
  methods: {
    ...
    reset() {
      this.form = {
        ...
        status: "0",
        // 新增：邮箱授权码字段
        emailAuthorizationCode: undefined  // 绑定输入框的值
      };
      this.resetForm("form");
    },
    /** 搜索按钮操作 */
