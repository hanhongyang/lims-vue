<template>
    <div class="app-container">
        <el-tabs v-model="activeTab" @tab-click="handleTabClick">
            <el-tab-pane label="待接收" name="1"></el-tab-pane>
            <el-tab-pane label="已接收" name="2"></el-tab-pane>
        </el-tabs>
        ...
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="委托单位" prop="deptName">
                <el-input v-model="queryParams.deptName" placeholder="请输入委托单位" clearable
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="送检时间" prop="sendSampleDateRange">
                <el-date-picker clearable v-model="queryParams.sendSampleDateRange" type="daterange"
        ...
        <el-table v-loading="loading" :data="sampleReceiveList" height="75%" style="max-height:75%;overflow-y: auto;"
            ref="multipleTable" @selection-change="handleSelectionChange" :row-key="getRowKeys">

            <el-table-column type="selection" width="55" :reserve-selection="true" :row-key="getRowKeys" />
            <el-table-column type="index" align="center" label="序号" width="50" />

            <el-table-column label="委托单号" align="center" prop="entrustOrderNo" min-width="140" key="col_order" />

            <el-table-column v-if="activeTab === '1'" label="样品数量" align="center" prop="sampleAmount" width="100"
                key="col_amount" />

            <el-table-column v-if="activeTab === '2'" label="样品编号" align="center" prop="sampleNo" min-width="140"
                key="col_sNo" />
            <el-table-column v-if="activeTab === '2'" label="样品名称" align="center" prop="sampleName" min-width="120"
                key="col_sName" />

            <el-table-column label="委托单位" align="center" prop="deptName" min-width="150" key="col_dept" />

            <el-table-column label="检测项目" align="center" prop="itemName" min-width="200" show-overflow-tooltip
                key="col_item" />

            <el-table-column v-if="activeTab === '2'" label="收样时间" align="center" prop="receiveTime" width="180"
                key="col_time">
            ...
            <el-table-column label="状态" align="center" prop="status" width="100" key="col_status">
                <template slot-scope="scope">
                    <dict-tag :options="dict.type.entrust_order_status" :value="scope.row.status" />
                </template>
            </el-table-column>

            <el-table-column label="备注" align="center" prop="remark" min-width="120" key="col_remark" />

            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="100" key="col_opt">
                <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            listSampleReceive(this.queryParams).then(response => {
