<template>
    <div class="app-container">
        ...
        <el-form ref="queryForm" :model="queryParams" size="small" inline label-width="100px">
            ...
            <el-form-item label="制单日期" prop="sendSampleDateRange">
        ...
        <el-table ref="multipleTable" v-loading="loading" :data="sampleReceiveList" height="70%" :row-key="getRowKeys">
            ...
            <el-table-column label="铅封号" align="center" prop="leadSealNumber" />
            <el-table-column label="铅封人" align="center" prop="sealedMan" />
...
<script>
import { listleadsealsheet } from '@/api/milkSource/SealRecordSheet'
export default {
    name: 'MilkTanker',
    dicts: [],
    data() {
    ...
    methods: {
        ...
        getList() {
            ...
            listleadsealsheet(this.queryParams).then(res => {
        ...
        /** 修改按钮操作 */
        handleUpdate(row) {
            const opLeadSealSheetId = row.opLeadSealSheetId
            this.$router.push({ path: '/milkSource/SealRecordSheetcreate', query: { opLeadSealSheetId: opLeadSealSheetId } });
        },
        handleExport() {
            this.download('leadsealsheet/sheet/export', {
                ...this.queryParams
            }, `铅封单_${this.activeTab}_${new Date().getTime()}.xlsx`)
        },
    }
}
</script>