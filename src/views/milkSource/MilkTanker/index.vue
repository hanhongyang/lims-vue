<template>
    <div class="app-container">
        ...
        <el-form ref="queryForm" :model="queryParams" size="small" inline label-width="100px">
            <el-form-item label="奶源计划" prop="inspectionMilkTankersNumber">
                <el-input v-model="queryParams.inspectionMilkTankersNumber" placeholder="请输入奶源计划" clearable
                    @keyup.enter.native="handleQuery" />
            </el-form-item>

            <el-form-item label="进场时间" prop="sendSampleDateRange">
        ...
        <el-table ref="multipleTable" v-loading="loading" :data="sampleReceiveList" height="70%" :row-key="getRowKeys">
            ...
            <el-table-column label="奶源计划" align="center" prop="inspectionMilkTankersNumber" width="180" />
            <el-table-column label="车牌号" align="center" prop="licensePlateNumber" />
            <el-table-column label="司机" align="center" prop="driverName" />
            <el-table-column label="挂车牌号" align="center" prop="trailerNumber" />
            <el-table-column label="进场时间" align="center" prop="entryTime" />
...
<script>
import { listinspectionMilk } from '@/api/milkSource/MilkTanker'
export default {
    name: 'MilkTanker',
    dicts: [],
    data() {
        return {
            ...
            queryParams: {
                pageNum: 1,
                pageSize: 10,
                inspectionMilkTankersNumber: null,
                // 用 status 待审核0 已审核 1
                status: null,
                sendSampleDateRange: [],
    ...
    methods: {
        ...
        getList() {
            ...
            listinspectionMilk(this.queryParams).then(res => {
        ...
        /** 修改按钮操作 */
        handleUpdate(row) {
            const inspectionMilkTankersId = row.inspectionMilkTankersId
            this.$router.push({ path: '/milkSource/MilkTankercreate', query: { inspectionMilkTankersId: inspectionMilkTankersId } });
        },
        handleExport() {

            this.download('inspectionMilk/tankers/export', {
                ...this.queryParams
            }, `奶罐车检查_${this.activeTab}_${new Date().getTime()}.xlsx`)
