...
<script>
import { listmilkTankInspection } from '@/api/milkSource/Milkcar'
export default {
    name: 'Milkcar',
    dicts: [],
    data() {
    ...
    methods: {
        ...
        getList() {
            ...
            listmilkTankInspection(this.queryParams).then(res => {
        ...
        handleUpdate(row) {
            ...
            this.$router.push({ path: '/milkSource/Milkcarcreate', query: { id: id } });
        },
        handleExport() {
            this.download('milkTankInspection/inspection/export', {
                ...this.queryParams
            }, `奶罐车质检_${this.activeTab}_${new Date().getTime()}.xlsx`)
        },
    }
}
</script>