<template>
    <div class="app-container">
        ...
        <el-form ref="queryForm" :model="queryParams" size="small" inline label-width="100px">
            <el-form-item label="奶仓名称" prop="entrustOrderNo">
                <el-input v-model="queryParams.entrustOrderNo" placeholder="请输入奶仓名称" clearable
                    @keyup.enter.native="handleQuery" />
            </el-form-item>

            <el-form-item label="检测日期" prop="sendSampleDateRange">
        ...
        <el-table ref="multipleTable" v-loading="loading" :data="sampleReceiveList" height="70%" :row-key="getRowKeys">
            ...
            <el-table-column label="化验单号" align="center" prop="inspectionNumber" width="150" />
            <el-table-column label="奶仓名称" align="center" prop="milkBinName" />
            <el-table-column label="潮次" align="center" prop="chaoCi" />
            <el-table-column label="数量(吨)" align="center" prop="quantity" />
            <el-table-column label="采样奶温" align="center" prop="samplingMilkTemperature" />
            ...
            <el-table-column label="取样时间" align="center" prop="samplingTime" />
            <el-table-column label="审核人" align="center" prop="reviewer" />
            <el-table-column label="审核日期" align="center" prop="reviewTime" />
...
<script>
import { listmilkbinqualityinspection } from '@/api/milkSource/MilkWarehouse'
export default {
    name: 'MilkWarehouse',
    dicts: [],
    data() {
    ...
    methods: {
        ...
        getList() {
            ...
            this.queryParams.status = this.activeTab === '1' ? '1' : '0'
            // 日期范围处理
            ...
            listmilkbinqualityinspection(this.queryParams).then(res => {
        ...
        handleUpdate(row) {
            const id = row.id
            this.$router.push({ path: '/milkSource/MilkWarehousecreate', query: { id: id } });
        },
        handleExport() {
            this.download('milkbinqualityinspection/export', {
                ...this.queryParams
            }, `奶仓质检_${this.activeTab}_${new Date().getTime()}.xlsx`)
        },
    }
}
</script>