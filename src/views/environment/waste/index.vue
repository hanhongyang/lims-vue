<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
      ...
      <el-form-item label="废弃物名称" prop="csgcarno">
        <el-input v-model="queryParams.csgcarno" placeholder="请输入废弃物名称" clearable style="width: 180px"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" border :data="datasetList" style="width: 100%;min-height: 200px;"
      ...
      <el-table-column label="公司" align="center" prop="q" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="废弃物名称" align="center" prop="w" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="来源" align="center" prop="e" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="数量" align="center" prop="r" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="运送日期" align="center" prop="t" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="运送人" align="center" prop="y" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="接收日期" align="center" prop="u" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="接收人" align="center" prop="i" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="灭菌时间" align="center" prop="o" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="灭菌温度" align="center" prop="p" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="操作人" align="center" prop="a" min-width="160" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="审核人" align="center" prop="createBy" width="100" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      //直接跳转
      this.$router.push('/environment/wastecreate');
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      const id = row.id;
