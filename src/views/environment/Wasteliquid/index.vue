<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="datasetList" style="width: 100%;min-height: 200px;"
      height="calc(100vh - 360px)">
      <el-table-column type="index" align="center" label="序号" width="50" />
      <el-table-column label="公司" align="center" prop="q" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="废液桶编号" align="center" prop="w" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="来源" align="center" prop="e" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="收集日期" align="center" prop="r" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="收集量" align="center" prop="t" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="主要成分" align="center" prop="y" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="收集人" align="center" prop="u" min-width="160" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      //直接跳转
      this.$router.push('/environment/Wasteliquidcreate');
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      const id = row.id;
      //直接跳转
      this.$router.push({
        path: '/environment/Wasteliquidcreate',
        query: { id },
      });
    },
    /** 修改按钮操作 */
