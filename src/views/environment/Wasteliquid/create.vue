    ...
    <div style="padding-top: 40px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="废液桶编号" prop="w">
          ...
          <el-col :span="8">
            <el-form-item label="收集日期" prop="gys">
              <el-date-picker v-model="form.r" style="width: 100%" type="date" placeholder="选择日期"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="收集量(ml)" prop="e">
              <el-input v-model="form.t" style="width: 100%" placeholder="请选择物料"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="主要成分" prop="e">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="收集人" prop="e">
              <el-input v-model="form.u" style="width: 100%" placeholder="请选择物料"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goBack() {
        const obj = { path: '/environment/Wasteliquid' }
