                ...
                <div class="biaotihd" style="margin-top: 150px;">
                    ...
                    <div class="lefttitle">
                        <div class="gongsi flex-line">
                            ...
                            <span class="content-line">牛口蹄疫检测</span>
                        </div>
                    </div>
                </div>
                <div class="gongsift">
                    ...
                    <table class="sample-table">
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="colspan-cell" style="padding:10px 0">
                                <div v-html="formatEvaluation(feedReportBase.testEvaluation)"></div>
                                <!-- {{ feedReportBase.testEvaluation }} -->
                            </td>
                        </tr>
                        <tr>
                            <th colspan="2">判定标准<br></th>
                            <!-- <td colspan="5" rowspan="1" class="colspan-cell">11</td> -->
                            <td colspan="4" class="colspan-cell" style="padding:10px 0">
                                <div v-html="formatEvaluation(feedReportBase.testCriterion)"></div>
                                <!-- <div>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="colspan-cell" style="padding:10px 0">
                                <div v-html="formatEvaluation(feedReportBase.sjph)"></div>
                                <!-- {{ feedReportBase.sampleBatchNo }} -->
                            </td>
                        </tr>
                    </table>
                    <div class="xfqm">
                ...
                <div class="report-container">
                    ...
                    <table class="sample-table" style=" font-size: 11px;">
                        <tr>
                            <td rowspan="2">管号</td>
                            <td rowspan="2">牛号</td>
                            <td colspan="2" v-if="aisShow">A型口蹄疫</td>
                            <td colspan="2" v-if="oisShow">O型口蹄疫</td>
                        </tr>
                        <tr>
                            <td v-if="aisShow">样品效价</td>
                            <td v-if="aisShow">结果判定</td>
                            <td v-if="oisShow">样品效价</td>
                            <td v-if="oisShow">结果判定</td>
                        </tr>
                        <tr v-for="(item, index) in pagedList[0]" :key="index">
                            <td>{{ item.gh }}</td>
                            <td>{{ item.sampleName }}</td>
                            <td v-if="aisShow">{{ item.aypxj }}</td>
                            <td v-if="aisShow">{{ item.atestResult }}</td>
                            <td v-if="oisShow">{{ item.oypxj }}</td>
                            <td v-if="oisShow">{{ item.otestResult }}</td>
                        </tr>
                    </table>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        ...
        // console.log(this.$route.query.isShowB, '2222222222')
