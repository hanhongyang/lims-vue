                ...
                <div class="report-container">
                    ...
                    <table class="sample-table">
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="colspan-cell" style="padding:10px 0">副结核抗体
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="xfqm">
                        ...
                        <div class="ttxf">批准:<img :src="signTypes.批准人" class="qm" v-if="feedReportBase.approveSign">
                        </div>
                    </div>
    ...
    mounted() {
        ...
        if (this.status == 0) {
            ...
            Reportsl(newAr).then(res => {
                ...
                res.data.opBloodJHReportSampleVo.fjhList.forEach((item) => {
