<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="datasetList" style="width: 100%;min-height: 200px;"
      ...
      <el-table-column label="故障名称" align="center" prop="ca" min-width="160" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="报障日期" align="center" prop="createTime" width="170">
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      //直接跳转
      this.$router.push('/instrument/faultcreate');
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      const id = row.id;
