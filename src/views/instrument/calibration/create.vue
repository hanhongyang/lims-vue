        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="设备型号" prop="gys">
              <el-input v-model="form.d" style="width: 100%" placeholder="请输入设备型号"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="校准结果" prop="i">
              <el-input v-model="form.e" style="width: 100%" placeholder="检验阶段"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="校准时间" prop="u">
              <el-input v-model="form.f" style="width: 100%" placeholder="校准时间"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goBack() {
        const obj = { path: '/instrument/calibration' }
            ...
            if (this.form.id != undefined) {
              ...
              createClasInfo(this.form).then((response) => {
                if (response.code == 200) {
                  ...
                  this.$router.push({
                    path: '/instrument/calibrationcreate',
                    query: { id },
                  })
                  this.getinfo()
                }
