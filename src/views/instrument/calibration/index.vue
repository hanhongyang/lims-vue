<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="datasetList" style="width: 100%;min-height: 200px;"
      ...
      <el-table-column label="校准结果" align="center" prop="d" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="校准时间" align="center" prop="e" min-width="160" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      //直接跳转
      this.$router.push('/instrument/calibrationcreate');
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      const id = row.id;
