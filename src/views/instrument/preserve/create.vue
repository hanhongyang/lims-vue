  ...
  <div class="app-container">
    ...
    <div style="padding-top: 40px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="8">
            <el-form-item label="保养单号" prop="q">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="保养日期" prop="u">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="保养描述" prop="cremark">
              <el-input type="textarea" v-model="form.cremark" placeholder="保养描述" :rows="3" maxlength="500"
                show-word-limit />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goBack() {
        const obj = { path: '/instrument/preserve' }
