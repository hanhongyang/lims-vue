<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="datasetList" style="width: 100%;min-height: 200px;"
      ...
      <el-table-column label="维修结果" align="center" prop="d" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="维修费用" align="center" prop="e" min-width="160" :show-overflow-tooltip="true" />
      <el-table-column label="维修日期" align="center" prop="createTime" width="170">
      ...
      <el-table-column label="钉钉审批单号" align="center" prop="u" min-width="160" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      //直接跳转
      this.$router.push('/instrument/maintenancecreate');
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      const id = row.id;
