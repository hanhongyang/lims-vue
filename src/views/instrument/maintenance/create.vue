  ...
  <div class="app-container">
    ...
    <div style="padding-top: 40px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="8">
            <el-form-item label="维修单号" prop="z">
              <el-input v-model="form.z" style="width: 100%" placeholder="自动生成"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="故障名称" prop="w">
              <el-input v-model="form.w" style="width: 100%" placeholder="请选择故障名称">
                <template #append>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="设备名称" prop="w">
              <el-input v-model="form.b" style="width: 100%" placeholder="请输入设备名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="设备编号" prop="c">
          ...
          <el-col :span="8">
            <el-form-item label="维修结果" prop="i">
              <el-input v-model="form.e" style="width: 100%" placeholder="维修结果"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="维修费用" prop="i">
              <el-input v-model="form.i" style="width: 100%" placeholder="维修费用"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="维修日期" prop="u">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="维修描述" prop="cremark">
              <el-input type="textarea" v-model="form.cremark1" placeholder="维修描述" :rows="3" maxlength="500"
                show-word-limit />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="原因分析" prop="cremark">
              <el-input type="textarea" v-model="form.cremark" placeholder="原因分析" :rows="3" maxlength="500"
                show-word-limit />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goBack() {
        const obj = { path: '/instrument/maintenance' }
            ...
            if (this.form.id != undefined) {
              ...
              createClasInfo(this.form).then((response) => {
                if (response.code == 200) {
                  ...
                  this.$router.push({
                    path: '/instrument/maintenancecreate',
                    query: { id },
                  })
                  this.getinfo()
                }
