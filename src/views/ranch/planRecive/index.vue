<template>
    <div class="app-container">
        ...
        <!-- ① 编辑主弹窗 -->
        <el-dialog title="编辑" :visible.sync="dialogVisible" width="400px" append-to-body>
...
export default {
    ...
    methods: {
        ...
        handleExport() {
            this.download('ranch/plan/exportReceiveList ', { ...this.queryParams }, `sampleReceive_${Date.now()}.xlsx`)
        },
        handleUpdate(row) {
