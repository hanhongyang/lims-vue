    ...
    <div class="report-a4">
        ...
        <table class="main-table">
            ...
            <tr>
                ...
                <th>检验类别</th>
                <td contenteditable @blur="syncField('inspectionCategory', $event)"
                    @keydown.enter.prevent="$event.target.blur()">
            ...
            <tr>
                <th>判定依据</th>
                <td colspan="3" contenteditable @blur="syncField('basisForJudgment', $event)"
                    @keydown.enter.prevent="$event.target.blur()">
            ...
            <tr>
                <th>包装规格</th>
                <td colspan="3" contenteditable @blur="syncField('packagingSpecifications', $event)"
                    @keydown.enter.prevent="$event.target.blur()">
                    {{ data.packagingSpecifications }}
                </td>
            </tr>
            <tr>
        ...
        <table class="result-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 24%">误差判定值</th>
                    <th style="width: 11%">实测值</th>
                    <th style="width: 17%">单项结论</th>
                </tr>
            </thead>
            <tbody>
