            ...
            context.addPrintElementTypes(
                ...
                [
                    new hiprint.PrintElementTypeGroup("常规", [
                        { tid: 'defaultModule.text', text: '文本', data: '', type: 'text' },
                        { tid: 'defaultModule.image', text: '图片', data: '', type: 'image' },
                        { tid: 'defaultModule.longText', text: '长文', data: '', type: 'longText' },
                        {
                        ...
                        {
                            tid: 'defaultModule.html', title: 'html',
                            formatter: function (data, options) {
                                return $('<div style="height:50pt;width:50pt;background:red;border-radius: 50%;"></div>');
                            },
                            type: 'html'
                        },
                        { tid: 'defaultModule.customText', text: '自定义文本', customText: '自定义文本', custom: true, type: 'text' }
                    ]),
